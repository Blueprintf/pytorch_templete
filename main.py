...
from utils import GpuDataParallel, Optimizer, Recorder, Stat, RandomState, Visualizer
...
class Processor():
    ...
    def __init__(self, arg):
        ...
        self.stat = Stat(self.arg.model_args['num_classes'])
        self.data_loader = {}
    ...
    def train(self, epoch):
        ...
        for batch_idx, data in enumerate(loader):
            ...
            lr = self.optimizer.adjust_learning_rate(batch_idx, epoch, len(loader))
            ...
            if batch_idx % self.arg.log_interval == 0:
                ...
                self.recoder.print_log(
                    '\tEpoch: {}, Batch({}/{}) done. Loss: {:.8f}  lr:{:.6f}'
                        .format(epoch, batch_idx, len(loader), loss.item(), lr))
    ...
    def eval(self, loader_name):
        ...
        for l_name in loader_name:
            ...
            for batch_idx, data in enumerate(loader):
                ...
                self.stat.update_accuracy(output.data.cpu(), label.cpu(), topk=(1, 5))
            print('mean loss: ' + str(np.mean(loss_mean)))
    ...
    def load_data(self):
        ...
        if self.arg.valid_feeder_args != {}:
            self.data_loader['test'] = torch.utils.data.DataLoader(
                dataset=Feeder(**self.arg.valid_feeder_args),
    ...
    def print_inf_log(self, epoch, mode):
        prec1, prec5 = self.stat.show_accuracy('{}/{}_confusion_mat'.format(self.arg.work_dir, mode))
    ...
    def fix_random_seed(self, seed=0):
